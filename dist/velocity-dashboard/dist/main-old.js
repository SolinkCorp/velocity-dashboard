...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ...
	  Widget: __webpack_require__(183),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AddWidgetPanel, Dashboard, DragDropContext, Layout, React, ReactCSSTransitionGroup, Title, _, componentWidthMixin, defaults, dndBackend, getComponentsById;
	...
	AddWidgetPanel = __webpack_require__(11);

	DragDropContext = __webpack_require__(12).DragDropContext;

	dndBackend = __webpack_require__(151);
	...
	Dashboard = React.createClass({
	  ...
	  shouldComponentUpdate: function(nextProps, nextState) {
	    ...
	    return nextProps !== this.props || nextState.editMode !== this.state.editMode || nextState.moveMode !== this.state.moveMode || cc1 !== cc2;
	  },
	  ...
	  childComponentsForConfig: function(components, config, editMode, moveMode, sizeConfig, columnCount) {
	    var componentsById, instances;
	    componentsById = getComponentsById(components);
	    instances = config.map((function(_this) {
	      return function(widget) {
	        ...
	        if (componentsById[widget.widgetId]) {
	          ...
	          return React.cloneElement(withPositions, {
	            ...
	            onConfigChange: _this.configChange,
	            onHide: function() {
	              return _this.hideWidget(widget.instanceId);
	            },
	  ...
	  toggleEditMode: function() {
	    var newEditMode;
	    newEditMode = !this.state.editMode;
	    this.setState({
	  ...
	  hideWidget: function(instanceId) {
	    var allConfigs, index;
	    allConfigs = [].concat(this.props.config);
	    index = _(allConfigs).findIndex(function(config) {
	      return config.instanceId === instanceId;
	    });
	    allConfigs.splice(index, 1);
	    return this.props.onConfigChange(allConfigs);
	  },
	  configChange: function(instanceId, newConfig) {
	    var allConfigs, index;
	    allConfigs = [].concat(this.props.config);
	    index = _(allConfigs).findIndex(function(config) {
	      return config.instanceId === instanceId;
	  ...
	  addWidget: function(id) {
	    var config;
	    config = [].concat(this.props.config);
	    config.push({
	      widgetId: id,
	  ...
	  moveWidget: function(draggingWidgetId, targetWidgetId) {
	    var config, sourceIndex, targetIndex;
	    config = [].concat(this.props.config);
	    targetIndex = _(config).findIndex(function(widget) {
	      return widget.instanceId === targetWidgetId;
	    });
	    sourceIndex = _(config).findIndex(function(widget) {
	      return widget.instanceId === draggingWidgetId;
	    });
	  ...
	  render: function() {
	    var addPanelChildren, children, childrenForCurrentConfig, className, componentWidth, config, contentWidth, editMode, layout, maxColumns, moveMode, ref, ref1, ref2, ref3, ref4, ref5, ref6, sizeConfig, title, titleHeight, widgetHeight, widgetMargin, widgetWidth;
	    ref = this.props, children = ref.children, title = ref.title, className = ref.className, config = ref.config, widgetHeight = (ref1 = ref.widgetHeight) != null ? ref1 : defaults.widgetHeight, widgetWidth = (ref2 = ref.widgetWidth) != null ? ref2 : defaults.widgetWidth, widgetMargin = (ref3 = ref.widgetMargin) != null ? ref3 : defaults.margin, titleHeight = (ref4 = ref.titleHeight) != null ? ref4 : 50, maxColumns = (ref5 = ref.maxColumns) != null ? ref5 : 5;
	    ref6 = this.state, editMode = ref6.editMode, moveMode = ref6.moveMode, componentWidth = ref6.componentWidth;
	    ...
	    childrenForCurrentConfig = this.childComponentsForConfig(children, config, editMode, moveMode, sizeConfig, layout.columnCount());
	    contentWidth = layout.columnCount() * (widgetWidth + widgetMargin) - widgetMargin;
	    if (layout.columnCount() === 1) {
	      contentWidth = '90%';
	    }
	    return React.createElement("div", {
	      "className": "dashboard " + className + " " + (editMode && !moveMode ? 'editing' : '')
	      ...
	      "className": "move-button " + (moveMode ? 'moving' : ''),
	    ...
	    }, (editMode && !moveMode ? (addPanelChildren = children.map((function(_this) {
	      return function(child) {
	        var preview;
	        preview = child.props.previewComp ? React.createElement(child.props.previewComp) : React.createElement("div", {
	        ...
	        return React.createElement("div", {
	          ...
	          "key": child.props.id,
	          "onClick": (function() {
	            return _this.addWidget(child.props.id);
	          })
	        }, React.createElement("div", {
	          "className": 'no-click'
	        }, preview));
	      };
	    })(this)), React.createElement(AddWidgetPanel, null, addPanelChildren)) : void 0)));
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AddWidgetPanel, React;

	React = __webpack_require__(3);

	AddWidgetPanel = function(arg) {
	  var children;
	  children = arg.children;
	  return React.createElement("div", {
	    "className": 'add-widget-panel'
	  }, children);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _DragDropContext = __webpack_require__(13);
	...
	var _DragDropContextProvider = __webpack_require__(127);
	...
	var _DragLayer = __webpack_require__(128);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dndCore = __webpack_require__(14);
	...
	var _checkDecoratorArguments = __webpack_require__(126);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _DragDropManager = __webpack_require__(15);
	...
	var _createTestBackend = __webpack_require__(124);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dragDrop = __webpack_require__(33);

	var dragDropActions = _interopRequireWildcard(_dragDrop);

	var _DragDropMonitor = __webpack_require__(117);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dragOperation = __webpack_require__(39);

	var _dragOperation2 = _interopRequireDefault(_dragOperation);

	var _refCount = __webpack_require__(98);

	var _refCount2 = _interopRequireDefault(_refCount);

	var _dirtyHandlerIds = __webpack_require__(99);

	var _dirtyHandlerIds2 = _interopRequireDefault(_dirtyHandlerIds);

	var _stateId = __webpack_require__(116);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _isObject = __webpack_require__(37);

	var _isObject2 = _interopRequireDefault(_isObject);

	var _matchesType = __webpack_require__(38);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _without = __webpack_require__(40);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _xor = __webpack_require__(100);

	var _xor2 = _interopRequireDefault(_xor);

	var _intersection = __webpack_require__(113);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var arrayFilter = __webpack_require__(101),
	    baseRest = __webpack_require__(85),
	    baseXor = __webpack_require__(102),
	    isArrayLikeObject = __webpack_require__(94);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseDifference = __webpack_require__(41),
	    baseFlatten = __webpack_require__(103),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var arrayMap = __webpack_require__(82),
	    baseIntersection = __webpack_require__(114),
	    baseRest = __webpack_require__(85),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _HandlerRegistry = __webpack_require__(118);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _asap = __webpack_require__(119);

	var _asap2 = _interopRequireDefault(_asap);

	var _registry = __webpack_require__(97);

	var _getNextUniqueId = __webpack_require__(121);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _noop = __webpack_require__(111);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _shallowEqualScalar = __webpack_require__(130);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _decorateHandler = __webpack_require__(132);

	var _decorateHandler2 = _interopRequireDefault(_decorateHandler);

	var _registerSource = __webpack_require__(138);

	var _registerSource2 = _interopRequireDefault(_registerSource);

	var _createSourceFactory = __webpack_require__(139);

	var _createSourceFactory2 = _interopRequireDefault(_createSourceFactory);

	var _createSourceMonitor = __webpack_require__(140);

	var _createSourceMonitor2 = _interopRequireDefault(_createSourceMonitor);

	var _createSourceConnector = __webpack_require__(141);

	var _createSourceConnector2 = _interopRequireDefault(_createSourceConnector);

	var _isValidType = __webpack_require__(145);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _disposables = __webpack_require__(133);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _isDisposable2 = __webpack_require__(134);

	var _isDisposable3 = _interopRequireWildcard(_isDisposable2);

	exports.isDisposable = _isDisposable3['default'];

	var _Disposable2 = __webpack_require__(135);
	...
	var _SerialDisposable2 = __webpack_require__(137);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _isDisposable = __webpack_require__(134);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _wrapConnectorHooks = __webpack_require__(142);

	var _wrapConnectorHooks2 = _interopRequireDefault(_wrapConnectorHooks);

	var _areOptionsEqual = __webpack_require__(144);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _cloneWithRef = __webpack_require__(143);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _registerTarget = __webpack_require__(147);

	var _registerTarget2 = _interopRequireDefault(_registerTarget);

	var _createTargetFactory = __webpack_require__(148);

	var _createTargetFactory2 = _interopRequireDefault(_createTargetFactory);

	var _createTargetMonitor = __webpack_require__(149);

	var _createTargetMonitor2 = _interopRequireDefault(_createTargetMonitor);

	var _createTargetConnector = __webpack_require__(150);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _HTML5Backend = __webpack_require__(152);

	var _HTML5Backend2 = _interopRequireDefault(_HTML5Backend);

	var _getEmptyImage = __webpack_require__(182);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _defaults = __webpack_require__(153);
	...
	var _EnterLeaveCounter = __webpack_require__(174);

	var _EnterLeaveCounter2 = _interopRequireDefault(_EnterLeaveCounter);

	var _BrowserDetector = __webpack_require__(176);

	var _OffsetUtils = __webpack_require__(178);

	var _NativeDragSources = __webpack_require__(180);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _union = __webpack_require__(175);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MonotonicInterpolant = __webpack_require__(179);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DragSource, DropTarget, ItemTypes, React, Widget, collectDragable, collectDropTarget, drop, ref, ref1, target, widgetSource;

	React = __webpack_require__(3);

	ref = __webpack_require__(184), drop = ref.drop, target = ref.target, collectDropTarget = ref.collectDropTarget, ItemTypes = ref.ItemTypes, widgetSource = ref.widgetSource, collectDragable = ref.collectDragable;

	ref1 = __webpack_require__(12), DropTarget = ref1.DropTarget, DragSource = ref1.DragSource;
	...
	Widget = React.createClass({
	  ...
	  hide: function() {},
	  render: function() {
	    var classes, col, columnCount, comp, config, configComp, connectDragSource, connectDropTarget, contentComp, dashEditable, draggable, editMode, height, instanceId, isDragging, isOver, onConfigChange, onHide, ref2, ref3, rendered, row, sizeConfig, styles, titleHeight, widgetHeight, widgetMargin, widgetWidth, width;
	    ref2 = this.props, instanceId = ref2.instanceId, height = ref2.height, width = ref2.width, col = ref2.col, row = ref2.row, dashEditable = ref2.dashEditable, draggable = ref2.draggable, config = ref2.config, onConfigChange = ref2.onConfigChange, onHide = ref2.onHide, contentComp = ref2.contentComp, configComp = ref2.configComp, sizeConfig = ref2.sizeConfig, columnCount = ref2.columnCount;
	    ref3 = this.props, connectDragSource = ref3.connectDragSource, isDragging = ref3.isDragging, connectDropTarget = ref3.connectDropTarget, isOver = ref3.isOver;
	    ...
	    rendered = React.createElement("div", {
	      ...
	      "className": 'dragbar'
	    }) : void 0), (dashEditable && !draggable ? editMode ? React.createElement("a", {
	      "className": "edit-widget-button close-button",
	      "onClick": this.toggleEditMode
	    }, "done") : React.createElement("span", null, (configComp ? React.createElement("i", {
	      "className": "fa fa-cog edit-widget-button",
	      "onClick": this.toggleEditMode
	    }) : void 0), React.createElement("i", {
	      "className": "fa fa-times hide-widget-button",
	      "onClick": onHide
	    })) : void 0), (comp = dashEditable && editMode ? configComp ? React.createElement("div", null, React.createElement("div", {
	      "className": 'config-comp'
	    }, React.createElement(configComp, {
	      instanceId: instanceId,
	      config: config,
	      onConfigChange: onConfigChange
	    })), React.createElement("i", {
	      "className": "fa fa-lg fa-cog background-watermark"
	    })) : React.createElement("div", null) : contentComp ? React.createElement(contentComp, {
	      instanceId: instanceId,
	      config: config
